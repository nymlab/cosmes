 ...
 */
export declare class QueryVerifyMembershipRequest extends Message<QueryVerifyMembershipRequest> {
    /**
     * client unique identifier.
     *
     * @generated from field: string client_id = 1;
 ...
 */
export declare class QueryVerifyMembershipResponse extends Message<QueryVerifyMembershipResponse> {
    /**
