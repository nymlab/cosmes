 ...
 */
export declare class QueryPoolTypeRequest extends Message<QueryPoolTypeRequest> {
    /**
     * @generated from field: uint64 pool_id = 1;
     */
    poolId: bigint;
 ...
 */
export declare class QueryPoolTypeResponse extends Message<QueryPoolTypeResponse> {
    /**
 ...
 */
export declare class QueryConcentratedPoolIdLinkFromCFMMRequest extends Message<QueryConcentratedPoolIdLinkFromCFMMRequest> {
    /**
 ...
 */
export declare class QueryConcentratedPoolIdLinkFromCFMMResponse extends Message<QueryConcentratedPoolIdLinkFromCFMMResponse> {
    /**
 ...
 */
export declare class QueryCFMMConcentratedPoolLinksRequest extends Message<QueryCFMMConcentratedPoolLinksRequest> {
 ...
 */
export declare class QueryCFMMConcentratedPoolLinksResponse extends Message<QueryCFMMConcentratedPoolLinksResponse> {
    /**
